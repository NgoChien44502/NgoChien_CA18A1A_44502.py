...
limit is assigned to a function named limitReached, whereas the task of computing a new approximation is assigned to
a function named improveEstimate. Each
